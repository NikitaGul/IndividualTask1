...
if(germanyChecker == 0 && ententeChecker == 0)
{
	...
	{
		if(ententeChecker == 0 && germanyChecker == 0)
		{
		germanyChecker = 1;
	...
	if(germanyChecker == 1 || ententeChecker == 1)
{
	...
	if(round == 3)
	{
		...
		finalResult[0] = 0;
		finalResult[1] = 0;
		name.setAttribute("style", "border-color: black; box-shadow: none; color: black; text-shadow: none");
		ententeName.setAttribute("style", "border-color: black; box-shadow: none; color: black; text-shadow: none");
	}
	...
	for(let i = 0; i < 2; ++i)
		...
		if(round == 3)
		{
			if(finalResult[0] > finalResult[1])
			{
				...
				name.setAttribute("style", "border-color: forestgreen; box-shadow: 1px 1px 5px 5px lime; color: forestgreen; text-shadow: 0px 0px 5px lime;");
				ententeName.setAttribute("style", "border-color: red; box-shadow: 1px 1px 5px 5px salmon; color: red; text-shadow: 0px 0px 5px salmon;");
			}
			if(finalResult[1] > finalResult[0])
			{
				...
				ententeName.setAttribute("style", "border-color: forestgreen; box-shadow: 1px 1px 5px 5px lime; color: forestgreen; text-shadow: 0px 0px 5px lime;");
				name.setAttribute("style", "border-color: red; box-shadow: 1px 1px 5px 5px salmon; color: red; text-shadow: 0px 0px 5px salmon;");
			}
			if(finalResult[0] == finalResult[1])
			{
